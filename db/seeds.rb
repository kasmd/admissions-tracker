...
Submission.create(student: student_1, course: wdi, status: "accepted", instructor_id: instructor, officer_id: officer, phonescreen_id: pass_phonescreen.id, interview_id: pass_interview.id)
